    ...
    params: [
      {
        ...
        type: 'json',
        required: true,
        hint: 'Lucid uses simplified field names — NOT standard SCIM schema. Use email (singular string), firstName, lastName, userName, password. Do not use emails[], name.givenName, or the schemas array.',
  ...
  scimModifyUserPut: {
    ...
    params: [
      { name: 'userId', label: 'User ID', type: 'string', required: true, hint: 'SCIM user resource ID' },
      {
        ...
        type: 'json',
        required: true,
        hint: 'Full replacement resource. Lucid uses simplified field names — NOT standard SCIM schema. Use email (singular string), firstName, lastName, userName. Do not use emails[], name.givenName, or the schemas array.',
        placeholder: '{\n  "email": "jdoe@example.com",\n  "firstName": "Jane",\n  "lastName": "Doe",\n  "userName": "jdoe@example.com"\n}',
      },
    ],
  },
